...
public class DataContext extends android.app.Application
{
    ...
    public void setResponseServers(int Code, String EndPoint)
    {
        Editor editor = getSharedPreferences().edit();
        editor.putString("Response"+EndPoint, Integer.toString(Code));
        editor.commit();
    }
    public String getResponseServers(String EndPoint)
    {
        String response;
        response = getSharedPreferences().getString("Response"+EndPoint, "");
        return response;
    }
}
