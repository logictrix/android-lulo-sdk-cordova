 ...
 * 
 */
package com.demo.app.kyc.model;
...
public class MainActivityModel
{
     ...
     */
    private State.ValidatedStateActivation validatedStateActivation = null;
     ...
     */
    public State.ValidatedStateActivation getValidatedStateActivation()
    {
     ...
     */
    public void setValidatedStateActivation(State.ValidatedStateActivation activated)
    {
        if (state != State.VALIDATED)
        {
            throw new IllegalStateException("Only the state VALIDATED supports validatedStateActivation or not.");
